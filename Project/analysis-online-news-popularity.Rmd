...
visualize_summary_plots <- function(df) {
  ...
  plt_popular_count <- ggplot(classification_df, aes(x = is_popular)) +
    geom_bar()+
    labs(x = "Popularity",
         y = "Frequency",
  ...
  plt_img_shares <- ggplot(classification_df, aes(x = num_imgs, y = shares, color = is_popular)) +
    #facet_wrap(~category) +
  ...
  plt_videos_shares <- ggplot(classification_df, aes(x = num_videos, y = shares, color = is_popular)) + 
    geom_point()+
    coord_cartesian(ylim = c(0,35000))
  ...
  plt_gsp_shares_category <- ggplot(classification_df, aes(x = global_sentiment_polarity, y = shares, color = is_popular)) + 
  ...
  plt_rpp_shares_category <- ggplot(classification_df, aes(x = rate_positive_words, y = shares, color = is_popular)) + 
    geom_point(alpha=1/2, na.rm = TRUE) +
    facet_wrap(~category) +
    coord_cartesian(ylim = c(0,20000))
  ...
  plt_mnp_shares_category <- ggplot(classification_df, aes(x = is_popular, y = min_negative_polarity)) +
    geom_boxplot(na.rm = TRUE) +
    facet_wrap(~category)
  print(plt_mnp_shares_category)
  
  #Plot 12: Global Rate Negative words w.r.t shares for each category 
  plt_grnw_shares_category <- ggplot(classification_df, aes(x = is_popular, 
  ...
  plt_n_tokens_content_shares <- ggplot(classification_df, aes(x = n_tokens_content, y = shares)) + 
  ...
  plt_global_sub_shares <- ggplot(classification_df, aes(x = global_subjectivity, 
  ...
  plt_avg_token_length_shares <- ggplot(classification_df, aes(x = average_token_length, y = shares)) + 
    geom_point(na.rm = TRUE)+
    coord_cartesian(ylim = c(0,20000))
  ...
  plt_num_key_shares_category <- ggplot(classification_df, aes(x = as.factor(num_keywords), 
                                                y = shares)) + 
    geom_bar(stat = "identity") +
    facet_wrap(~category)
  ...
  plt_num_href_shares <- ggplot(classification_df, aes(x = num_hrefs, y = shares)) + 
  ...
  plt <- ggplot(classification_df, aes(x = is_popular, y = kw_avg_avg)) + 
    geom_boxplot(na.rm = TRUE) +
    facet_wrap(~category) + 
    coord_cartesian(ylim = c(0, 20000))
  print(plt)
  
  ## Title subjectivity plot
  plt_title_subj <- ggplot(classification_df, aes(x = is_popular, y = title_subjectivity))+
    geom_boxplot(na.rm = TRUE) +
    facet_wrap(~category)
...
#test_df <- prepare_data_classification(classification_df)
